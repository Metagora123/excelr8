      ...
      <div className="px-4 lg:px-6 space-y-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Messages sent, invites, replies, engagement. All metrics from Supabase campaigns table.
          </p>
        </div>
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Messages and invites</CardDescription>
                </CardHeader>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Replies, comments, likes</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
            ...
            {barData.length > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Up to 12 campaigns</CardDescription>
                </CardHeader>
                <CardContent>
