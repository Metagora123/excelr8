...
/**
 * GET/POST /api/auto-comment-automations/run-scheduled
 * Runs comment generation flow for all active auto-comment automations.
...
export async function GET(req: Request) {
  ...
  for (const project of PROJECTS) {
    ...
    for (const a of active) {
      try {
        await runAutoCommentAutomation(project, a.id)
